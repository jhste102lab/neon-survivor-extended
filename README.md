...
No install, no downloads, no account required — open the page and survive as long as you can on PC or mobile. The current v1.1.5 Cloudflare build includes global leaderboard support, 24 weapon evolutions, the 10/13/16-minute endless fusion boss loop, boss affixes such as Devour, Drop Seal, Weapon Silence, and Control Warp, 0.5x late-game precision speed, stacked drops, clearer invulnerability feedback, adaptive late-game clarity for crowded screens, reduced mobile enemy pop-in, smoother mobile dense-swarm rendering, and crash-safe run restore.
