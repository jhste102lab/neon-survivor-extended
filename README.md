...
No install, no downloads, no account required — open the page and survive as long as you can on PC or mobile. The current v1.1.4 Cloudflare build includes global leaderboard support, 24 weapon evolutions, recurring fusion bosses, 0.5x late-game precision speed, stacked drops, clearer invulnerability feedback, adaptive late-game clarity for crowded screens, mobile runtime stabilization, and crash-safe run restore.
