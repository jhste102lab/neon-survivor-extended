...
インストールもダウンロードもアカウントも不要です。PC でもモバイルでも、ページを開けばすぐに遊べます。現在の v1.1.3 Cloudflare ビルドには、グローバルランキング、24 種類の武器進化、10 分ごとに戻ってくる合体ボス、8 分後に解放される 0.5x 精密速度、スタック式ドロップ、無敵表示、後半の自動視認性補正が含まれます。
