...
インストールもダウンロードもアカウントも不要です。PC でもモバイルでも、ページを開けばすぐに遊べます。現在の v1.1.9 Cloudflare ビルドには、グローバルランキング、24 種類の武器進化、10/13/16 分へ続くエンドレス合体ボスループ、吸収・ドロップ封印・武器沈黙・操作歪曲のボス能力、緩和された 10 分最初の合体ボス、mass layer を使わない滑らかな密集敵処理、8 分後に解放される 0.5x 精密速度、スタック式ドロップ、無敵表示、後半の自動視認性補正、仲間ネオンカード強調が含まれます。
