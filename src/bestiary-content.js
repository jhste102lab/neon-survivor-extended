...
const BESTIARY_ENTRIES = [
  ...
  { tab: 'dimension', ref: 'dimension:bullet_nebula', icon: '🌌', title: '탄막 성운', role: '탄막 회피 + 코어 파괴', danger: '높음', appears: '차원균열/차원 시련', behavior: '성운 코어와 노드가 원형/나선 탄막을 발사합니다.', risk: '탄막 가독성을 놓치면 연속 피격됩니다.', tip: '코어 우선 타겟팅을 믿고 빈틈을 따라 움직이세요.' },
  { tab: 'dimension', ref: 'dimension:machine_prison', icon: '⚡', title: '기계 감옥', role: '레이저 회피 + 발전기 파괴', danger: '높음', appears: '차원균열/차원 시련', behavior: '레이저, 전기벽, 문 패턴 사이에서 발전기를 파괴합니다.', risk: '예고선을 늦게 보면 안전칸을 잃습니다.', tip: '발전기 파괴 후 나오는 보급을 활용하세요.' },
  { tab: 'dimension', ref: 'dimension:gravity_well', icon: '🕳️', title: '중력 우물', role: '중력 조작 + 웨이브 처치', danger: '매우 높음', appears: '차원균열/차원 시련', behavior: '끌림과 밀림이 반복되고 앵커 주변에 탄막이 생깁니다.', risk: '중력에 과하게 저항하면 이동 경로가 꼬입니다.', tip: '적이 뭉치는 순간 광역 화력으로 녹이세요.' },
  { tab: 'dimension', ref: 'dimension:judges_duel', icon: '⚖️', title: '심판자의 결투', role: '느린 패턴 보스전', danger: '매우 높음', appears: '차원균열/차원 시련', behavior: '십자 레이저, 부채꼴 탄막, 안전지대 장판을 사용합니다.', risk: '빠른 추격은 아니지만 판단 실수가 큰 피해로 이어집니다.', tip: '움직여야 하는 패턴과 멈춰야 하는 패턴을 구분하세요.' },
  { tab: 'dimension', ref: 'dimension:plague_garden', icon: '🍄', title: '역병 정원', role: '오염 영역 관리', danger: '매우 높음', appears: '차원균열/차원 시련', behavior: '독성 포자와 둥지가 오염 구역을 퍼뜨립니다.', risk: '한 방향으로만 도망치면 오염에 갇힙니다.', tip: '둥지를 하나씩 정리하며 회복 드롭을 확보하세요.' },
  { tab: 'dimension', ref: 'dimension:mirror_corridor', icon: '🔷', title: '거울 회랑', role: '진짜/가짜 판단', danger: '높음', appears: '차원균열/차원 시련', behavior: '진짜 거울핵과 가짜 핵, 반사탄, 프리즘 레이저가 등장합니다.', risk: '가짜 핵을 건드리면 반격 탄막이 늘어납니다.', tip: '시각 단서를 보고 진짜 핵을 우선 파괴하세요.' },
  { tab: 'dimension', ref: 'dimension:train_battlefield', icon: '🚄', title: '열차 위 전장', role: '이동 전장 + 웨이브 방어', danger: '매우 높음', appears: '차원균열/차원 시련', behavior: '움직이는 전장에서 드론 습격과 강습선을 막습니다.', risk: '장애물과 적 처치가 겹치면 시야가 흔들립니다.', tip: '화면 중앙을 유지하고 폭탄 드롭을 아끼지 마세요.' },
  { tab: 'dimension', ref: 'dimension:casino_rift', icon: '🎰', title: '도박장의 균열', role: '계약 선택 전투', danger: '매우 높음', appears: '차원균열/차원 시련', behavior: '공개된 위험/보상 계약을 고르고 3라운드를 승리합니다.', risk: '고위험 계약을 연속으로 고르면 탄막이 급격히 늘어납니다.', tip: '현재 체력과 빌드에 맞는 계약을 고르세요.' },
