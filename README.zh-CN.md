...
无需安装、无需下载、无需账号。打开网页即可在 PC 或移动端开局。当前 v1.2.0 Cloudflare 构建包含**维度模式重做**：10 分钟裂隙守门人、需要停留 5 秒的传送门、可自由往返的维度枢纽、8 个可选择并通关的维度、崩塌自动脱出、维度遗物/奖励卡、开源传送门装饰资源、图鉴实际数值显示，以及 Overclock 实际 7% 攻击间隔缩短的文本修正。
