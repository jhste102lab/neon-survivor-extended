...
无需安装、无需下载、无需账号。打开网页即可在 PC 或移动端开局。当前 v1.1.6 Cloudflare 构建包含全球排行榜、24 种武器进化、10/13/16 分钟循环推进的无尽合体 Boss、吞噬/掉落封印/武器沉默/控制扭曲等 Boss 词缀、更温和的 10 分钟首个合体 Boss、无需 mass layer 的顺滑密集怪群处理、8 分钟后解锁的 0.5x 精准速度、叠加掉落、无敌提示、后期自适应清晰度优化，以及伙伴 Neon 卡牌强调。
