...
无需安装、无需下载、无需账号。打开网页即可在 PC 或移动端开局。当前 v1.1.5 Cloudflare 构建包含全球排行榜、24 种武器进化、10/13/16 分钟循环推进的无尽合体 Boss、吞噬/掉落封印/武器沉默/控制扭曲等 Boss 词缀、8 分钟后解锁的 0.5x 精准速度、叠加掉落、无敌提示、后期自适应清晰度优化、移动端敌人突现缓解、更顺滑的移动端密集怪群渲染，以及崩溃后的继续恢复。
